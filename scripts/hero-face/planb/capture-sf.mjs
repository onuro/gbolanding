...
//        [--wait-expr "window.__ready===true"] [--canvas 1] [--timeout 60000] [--port 9847]
...
const port = +(args.port || 9847); // Plan B devtools range 9800-9899
...
const prof = '/private/tmp/claude-501/-Users-onuroztaskiran-FE-Apps-tt6-gbolanding/ec762eb5-0e84-43b6-a8c2-a6f1c54d7112/scratchpad/hero-face/planb/chrome-prof-' + angle;
