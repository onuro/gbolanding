#!/bin/sh
# Plan B look iteration: render labelled variants and put them on one crop sheet.
...
export HERE; MULTI=$LIST sh "$HERE/render-v002.sh" > /dev/null
ARGS=""
node -e '
