          ...
          <div className="hero-bg relative isolate flex flex-1 flex-col items-center justify-center gap-12 overflow-hidden px-6 py-16 text-center sm:gap-14 sm:py-20">
            ...
            <div className="animate-fade-in flex flex-col items-center gap-5">
              ...
              <p className="max-w-xl text-pretty text-sm leading-relaxed text-muted-foreground sm:text-base">
                GBO Vision develops and deploys enterprise AI for regulated industries—from
                Kollektor, an autonomous agent for law firm debt collection, to Intelval,
                an AI-driven business and real estate valuation platform.
              </p>
            </div>
        ...
        <footer className="relative h-(--footer-height) px-6">
          <div className="flex h-full items-center">
            <span className="font-mono text-[11px] text-muted-foreground">
              © {new Date().getFullYear()} GBO Vision — All rights reserved
            </span>
          </div>
