...
// P2 (PLAN.md §3): current pose at half resolution, RGBA8 with mipmaps.
// R = dim continuous face (eyelids, iris disc, pupil, teeth), G = silhouette mask (edge dissolution).

export interface GhostPass {
  target: THREE.WebGLRenderTarget;
  mesh: THREE.Mesh;
  uniforms: { uGhostK: THREE.IUniform<THREE.Vector4>; uGhostK2: THREE.IUniform<THREE.Vector4> };
